...
! function(e) {
	...
	function i(e, t) {
		...
		if (e && "." === e.charAt(0))
			if (t) {
				for (h = h.slice(0, h.length - 1), e = e.split("/"), o = e.length - 1, f.nodeIdCompat && b.test(e[o]) && (e[o] = e[o].replace(b, "")), e = h.concat(e), c = 0; c < e.length; c += 1)
	...
	u = function(e, t) {
		...
		if (l = l || i, "undefined" === _ || "function" === _) {
			for (n = !n.length && s.length ? ["require", "exports", "module"] : n, w = 0; w < n.length; w += 1)
				if (v = u(n[w], l), c = v.f, "require" === c) y[w] = p.require(i);
				else if ("exports" === c) y[w] = p.exports(i), b = !0;
			else if ("module" === c) d = y[w] = p.module(i);
			else if (t(h, c) || t(m, c) || t(g, c)) y[w] = o(c);
			else {
				if (!v.p) throw new Error(i + " missing " + c);
				v.p.load(v.n, a(l, !0), r(c), {}), y[w] = h[c]
			}
			f = s ? s.apply(h[i], y) : void 0, i && (d && d.exports !== e && d.exports !== h[i] ? h[i] = d.exports : f === e && b || (h[i] = f))
		} else i && (h[i] = s)
	...
	function(e) {
		...
		p(), e[a] = l
	}(window), define("libs/routie", function() {}), define("libs/core", ["libs/routie"], function() {
		function e(e, a) {
		...
		function i(e) {
			for (var t = [], i = y.config.layout ? 1 : 0; i < e.length; i++) {
				t.push("/" + e[i].page);
				var n = a(e[i].params);
				n && t.push(":" + n)
			}
		...
		function r(e) {
			var t = e.split("/");
			t[0] || (y.config.layout ? t[0] = y.config.layout : t.shift());
		...
		function l(e, t) {
			...
			if (i) {
				var a = i.page,
					n = 0 === a.indexOf(".");
				if (n && (a = (e.fullname || "") + a), a = a.replace(/\./g, "/"), d(b, a, i, t, e) === !1) return;
		...
		function g(e) {
			if (y.debug && console.log(e.stack), !e.requireModules) throw e;
			y.debug && webix.message({
				type: "error",
				expire: 5e3,
				text: "Can't load " + e.requireModules.join(", ")
			}), y.show(y.config.start)
		}
		var v = [],
			w = [],
			b = [],
			y = {
				create: function(e) {
					y.config = webix.extend({
						name: "App",
						version: "1.0",
						container: document.body,
						start: "/home"
					}, e, !0), y.debug = e.debug, y.$layout = {
						sub: n,
						root: y.config.container,
						index: 0,
						add: !0
					}, webix.extend(y, webix.EventSystem), setTimeout(function() {
						webix.ready(function() {
							y.start()
						})
					}, 1);
					var t = y.config.container;
				...
				router: function(e) {
					var t = r(e);
					y.path = [].concat(t), l(y.$layout, t)
				},
				show: function(e, t) {
					routie.navigate("!" + e, t)
				},
				start: function() {
					routie("!*", y.router), window.location.hash ? (webix.ui.$freeze = !1, webix.ui.resize()) : y.show(y.config.start)
				},
				use: function(e, t) {
					e.$oninit && e.$oninit(this, t || {}), e.$onurlchange && w.push(e.$onurlchange), e.$onurl && b.push(e.$onurl), e.$onui && v.push(e.$onui)
				},
				trigger: function(e) {
					y.apply(e, [].splice.call(arguments, 1))
				},
				apply: function(e, t) {
					y.callEvent(e, t)
				},
	...
	}(this), define("libs/polyglot", function() {}), define("models/user", [], function() {
		function e(e, t) {
			...
			function p(e) {
				...
				for (l = 2, d = t.length; d > l; l += 2) {
					...
					if (r = u.exec(t[l])) v = {
						...
						if (b && (c = i(v.url))) {
							c = c.join("\n");
							var y = c.indexOf(b.innerText);
							y >= 0 && (v.line = w + c.substring(0, y).split("\n").length)
						}
	...
	}, webix.ui.button), define("views/webix/icon", function() {}), webix.type(webix.ui.tree, {
		name: "menuTree",
		height: 40,
		folder: function(e) {
	...
	}), define("views/webix/menutree", function() {}), define("views/app", ["views/menus/search", "views/menus/mail", "views/menus/message", "views/menus/profile", "views/menus/sidebar", "views/webix/icon", "views/webix/menutree"], function(e, t, i, a, n) {
		var r = {
				view: "toolbar",
				css: "header",
				elements: [{
					...
					borderless: !0,
					css: "logo",
					template: "<a href='http://webix.com'><img class='photo' src='assets/imgs/logo.png?555' /></a>",
					width: 200
				}, {
					height: 46,
					id: "person_template",
					...
					template: function(e) {
						...
						return t += "<img class='photo' src='assets/imgs/photos/" + e.id + ".png' /><span class='name'>" + e.name + "</span>", t += "<span class='webix_icon fa-angle-down'></span></div>"
					}
				}, {}, {
					view: "icon",
					icon: "search",
	...
	}, webix.ui.view), define("views/webix/scheduler", function() {}), define("models/events", [], function() {
		...
		return {
			$ui: {
				...
				css: "tiles",
				template: function(e) {
					for (var t = null, i = e.items, a = "<div class='flex_tmp'>", n = 0; n < i.length; n++) t = i[n], a += "<div class='item " + t.css + " bg_panel'>", a += "<div class='webix_icon icon fa-" + t.icon + "'></div>", a += "<div class='details'><div class='value'>" + t.value + "</div><div class='text'>" + t.text + "</div></div>", a += "<div class='footer'>View more <span class='webix_icon fa-angle-double-right'></span></div>", a += "</div>";
					return a += "</div>"
				},
				data: {
					items: [{
	...
	}, webix.ui.view), define("views/webix/googlemap", function() {}), define("views/modules/map", ["views/webix/googlemap"], function() {
		var e = {
			rows: [{
		...
		name: "edittree"
	}, webix.EditAbility, webix.ui.tree), define("views/webix/editable", function() {}), webix.type(webix.ui.tree, {
		name: "fileTree",
		css: "file",
		height: 40,
	...
	}), define("views/webix/filetree", function() {}), define("views/modules/edittree", ["models/files", "views/webix/editable", "views/webix/filetree"], function(e) {
		var t = {
			id: "fileTree",
			view: "edittree",
			editable: !0,
	...
	}), define("views/webix/fileview", function() {}), define("views/files", ["models/files", "views/modules/edittree", "views/webix/fileview"], function(e, t) {
		var i = {
			type: "clean",
			margin: -8,
			rows: [{
	...
	}, webix.ui.view), define("views/webix/ckeditor", function() {}), define("views/modules/editor", ["views/webix/ckeditor"], function() {
		var e = {
				view: "form",
				id: "mainView",
				elementsConfig: {
		...
		var e = {
				...
				rows: [{
					...
					cols: [{
						...
						template: 'css: "button_primary"',
						css: "center"
					}, {
						template: 'css: "button_info"',
						css: "center"
					}]
				}]
			},
			t = {
				...
				rows: [{
					...
					cols: [{
						...
						view: "button",
						label: "Transparent",
						css: "bg_primary button_transparent",
						align: "left"
					}]
				}, {
					type: "clean",
					cols: [{
						template: 'css: "button_success"',
						css: "center"
					}, {
						template: 'css: "button_warning"',
						css: "center"
					}, {
						template: 'css: "button_danger"',
						css: "center"
					}, {
						template: 'css: "button_transparent"',
						css: "center"
					}]
				}]
			},
		...
		var e = {
				cols: [{
					...
					template: 'css: "text_primary"',
					css: "text_primary"
				}, {
					template: 'css: "text_info"',
					css: "text_info"
				}, {
					template: 'css: "text_success"',
					css: "text_success"
				}]
			},
			t = {
				cols: [{
					template: 'css: "text_warning"',
					css: "text_warning"
				}, {
					template: 'css: "text_danger"',
					css: "text_danger"
				}, {
					template: 'css: "text_muted"',
					css: "text_muted"
				}, {}]
			},
			i = {
		...
		var e = {
				cols: [{
					...
					template: 'css: "bg_primary"',
					css: "bg_primary"
				}, {
					template: 'css: "bg_info"',
					css: "bg_info"
				}]
			},
			t = {
				cols: [{
					template: 'css: "bg_success"',
					css: "bg_success"
				}, {
					template: 'css: "bg_warning"',
					css: "bg_warning"
				}, {
					template: 'css: "bg_danger"',
					css: "bg_danger"
				}]
			},
			i = {
	...
	}), define("views/typography", ["views/typography/buttons", "views/typography/raised", "views/typography/text", "views/typography/background"], function(e, t, i, a) {
		var n = {
			type: "material",
			rows: [{
				rows: [{
				...
				rows: [{
					...
					cols: [{
						css: "solid_icon",
						template: "<span class='webix_icon fa-plus-circle' style='cursor:pointer;'></span>Add Icon"
					}, {
						css: "action_icon",
						template: "<span class='webix_icon fa-edit' style='cursor:pointer;'></span>Edit Icon"
					}, {
						css: "danger_icon",
						template: "<span class='webix_icon fa-times' style='cursor:pointer;'></span>Remove Icon"
					}]
				}, {
					paddingX: 25,
					paddingY: 10,
				...
				rows: [{
					...
					cols: [{
						view: "template",
						template: 'css:"bg_clean"',
						css: "bg_clean"
					}, {
						view: "template",
						template: 'css:"bg_panel"',
						css: "bg_panel"
					}, {
						view: "template",
						template: 'css:"bg_panel_raised"',
						css: "bg_panel_raised"
					}]
				}]
			}]
